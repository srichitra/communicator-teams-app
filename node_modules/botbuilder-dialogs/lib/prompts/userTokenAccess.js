...
const ExtendedUserTokenProviderT = z.custom((val) => typeof val.exchangeToken === 'function' &&
...
const ConnectorClientBuilderT = z.custom((val) => typeof val.createConnectorClientWithIdentity === 'function', {
