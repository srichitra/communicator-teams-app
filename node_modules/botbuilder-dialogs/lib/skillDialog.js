...
const UserTokenAccess = __importStar(require("./prompts/userTokenAccess"));
/**
...
class SkillDialog extends dialog_1.Dialog {
    ...
    interceptOAuthCards(context, activity, connectionName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield UserTokenAccess.exchangeToken(context, { title: 'Sign In', connectionName: connectionName }, { uri });
    ...
    createSkillConversationId(context, activity) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                skillConversationId =
                    yield this.dialogOptions.conversationIdFactory.createSkillConversationIdWithOptions(conversationIdFactoryOptions);
            }
            catch (err) {
